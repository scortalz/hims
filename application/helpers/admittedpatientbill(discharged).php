...
<u>DISCHARGED PATIENT BILL(IPD)</u>
 ...
 <table width="100%" style="text-align:center;padding: 0px 2px 1px 2px;border: 1px solid; border-color: #0000;border-radius:20px;">
   <tr>		
	...
	<td style="text-align:left;padding: 0px 2px 1px 2px;">'.number_format($Rs[0]['totalamount'], 2).'</td>
	<td style="text-align:left;padding: 0px 2px 1px 2px;"> '.number_format($Rs[0]['discount'], 2).'</td>
	<td style="text-align:left;padding: 0px 2px 1px 2px;">'.number_format($Rs[0]['discountamount'], 2).'</td>
	<td style="text-align:left;padding: 0px 2px 1px 2px;">500 </td>
	<td style="text-align:left;padding: 0px 2px 1px 2px;">'.number_format($Rs[0]['recievedamount'], 2).'</td>
	<td style="text-align:left;padding: 0px 2px 1px 2px;">'.number_format($Rs[0]['dueamount'], 2).'</td>
		</tr>
		<tr>		

    ...
    <body style="margin:0; height:1100;">
    <embed id="samplePDF" type="application/pdf" src="<?php echo $pfn; ?>"   width="100%" height="1100"   />
    ...
    <iframe src="<?php echo $pfn; ?>" id="objAdobePrint" name="objAdobePrint" height="1100" width="100%" frameborder=0></iframe>

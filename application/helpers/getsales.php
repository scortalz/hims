...
// Check Posted Data Has Value In It
	...
	{
		$invoices = $Db->getSalesReport($_POST['post_selected_date'], $_POST["post_selected_date_to"]);
		/*echo  "<pre>";
		print_r($invoices);
		echo "</pre>";
		exit;*/
          		 ...
          		 <?php $rep_html ='<table cellpadding="0" cellspacing="0" border="0" class="dTable responsive" style="width:100%;">
					...
					<tr>
                        <td align="center"  colspan="5">
						 ...
						 <tr>
                        <td align="center"  colspan="5">
                      <h1 class="hidedata">Sales Report</h1></td>
                        </tr>
						...
						<th style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;"><div>Due Amount</div></th>
                    ...
                    <tbody>';
						...
						<td style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;text-align:right;">'.number_format(($invoices[$i]['dueamount']), 0).'</td>
...
?>	   
						...
						/*
						 ...
						 file_put_contents("../../reports/salesreport.pdf", $pdf);
				  */
    ?>
 	      </div>
          <input type="button" class="btn btn-green" name="print" id="print" value="Print" onClick="forprintdiv()" />

...
<td>
<select onchange="calculateTime()" id="1_open_time" name="1_open_time" class="1_open_time" style="width:106px;">
...
<select onchange="calculateTime()"  id="1_close_time" name="1_close_time" class="1_open_time" style="width:106px;">
...
try
{
	...
	{
		//$datas = $Db->getotbookedtime($_POST['doctor_id']);
		$datas = $Db->getotbookedtime($_POST['ot1_id']);
		//print_r($datas);exit;
	...
	//	echo $data['1_close_time'];
		if($datas=="")
		{
			...
			echo $datas['1_open_time'];
			echo $datas['1_close_time'];
			}
			else
			{

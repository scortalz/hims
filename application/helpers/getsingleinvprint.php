...
/*try
{
	...
	if(isset($inv_id))
	{
		$InvoiceDiscount = $Db->getsingleinvprint($inv_id);
...
<tr style="vertical-align:top;">
    <td width = "20%"><img class="hidedata" style="margin-left:0px;" src="../helpers/img/report.png" width = "150px" height = "100px "></td><td><h2><br>Batool General Hospital &nbsp;</h2></td>
 ...
 <table width="100%" style="text-align:center;padding: 0px 2px 1px 2px;border: 1px solid; border-color: #0000;border-radius:20px;">
   ...
   <td style="text-align:left;padding: 0px 2px 1px 50px; ">'.number_format($Rs[0]['dueamount'],2).'</td>
   		</tr>
...
<form  target="_blank" action="application/helpers/print.php" method="post">

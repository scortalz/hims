          ...
          <?php	if(isset($edit_profile)):?>
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/surgery/edit/do_update/'.$row['type_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
						 <div class="control-group">
                            ...
                            <div class="control-group">
							  ...
							  <div class="control-group">
                                ...
                                <div class="controls">
                               <input type="text" name="type" id="type" id="type" value="<?php echo $row['type']; ?>"/>
                                </div>
                            </div>
                           </div>
                    ...
                    <tbody>
                     ...
                     <?php $count = 1;foreach($surgerys as $rows):?>
					   ...
					   <td><?php echo $rows['type'];?></td>
							<td align="center">
                            <a href="<?php echo base_url();?>index.php?admin/surgery/edit/<?php echo $rows['type_id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/surgery/delete/<?php echo $rows['type_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/surgery/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
						<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('surgery name');?></label>
                                <div class="controls">

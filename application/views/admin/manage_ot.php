          ...
          <?php	if(isset($edit_profile)):?>
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_ot/edit/do_update/'.$row['ot_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
						...
						<div class="control-group">
                                ...
                                <div class="controls">
                         <input type="text" class="" name="anesthesia_name" id="anesthesia_name" value="<?php echo $row['anesthesia_name']; ?>"/>
                                </div>
                            </div>
							<div class="control-group">
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="datepicker fill-up" name="case_date" value="<?php echo $row['case_date'] ?>"/>
                                </div>
                            </div>
							<!--<div class="control-group">
							  ...
							  <div class="control-group">
                                ...
                                <div class="controls">
                                  <select name="surgery_id" id="surgery_id" class="uniform" >
                                    	<?php 
							 ...
							 <div class="control-group">
                                ...
                                <div class="controls">
                                <select name="type_id" id="type_id" class="uniform" >
                                    	<?php 
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="booked_id" class="uniform" style="width:100%;">
                                    	<?php 
				...
				<td style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;">'.date('m / d / Y', strtotime($rows['case_date'])).'</td>
                     ...
                     <?php $count = 1;foreach($ot1 as $rows):?>
                       ...
                       <td><?php echo date('m / d / Y', strtotime($rows['case_date']));?></td>
							...
							<td align="center">
                            <a href="<?php echo base_url();?>index.php?admin/manage_ot/edit/<?php echo $rows['ot_id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/manage_ot/delete/<?php echo $rows['ot_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/manage_ot/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                              <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('OT');?></label>
                                <div class="controls">
                       <select name="ot1_id" id="ot1_id" class="uniform" style="width:100%;" onclick="getot()"> 
                              ...
                              <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('patient name');?></label>
                                <div class="controls">
								<select class="chzn-select" name="patient_id" id="patient_id" onclick="getdoctor()">
                                <option>-----------Select Patient------</option>
										<?php 
										$patients =	$this->db->get('patient')->result_array();
										foreach($patients as $row):
										?>
                                        	<option value=" <?php echo $row['patient_id'];?> "><?php echo $row['patient_reg_no'].$row['name'];?></option>
                                        <?php
										endforeach;
										?>
									</select>
							...
							<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('sub category ');?></label>
                                <div class="controls" id='sub_cate'>

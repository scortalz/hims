		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/diagnostic_service/edit/do_update/'.$row['diagnosticservice_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                         <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('title');?></label>
                                <div class="controls">
                                    <select name="diagnostictype_id" class="uniform" style="width:100%;">
                                    	<?php 
										$diagnostictypes = $this->db->get('diagnostictype')->result_array();
										foreach($diagnostictypes as $row2):
										?>
                                    		<option value="<?php echo $row2['diagnostictype_id'];?>"
                                            	<?php if($row['diagnostictype_id'] == $row2['diagnostictype_id'])echo 'selected';?>>
													<?php echo $row2['name'];?>
                                                    	</option>
                                        <?php
										endforeach;
                     ...
                     <?php
					  ...
					  $count = 1;foreach($diagnosticservices as $row):?>
                        <tr>
							...
							<td align="center">
                            <a href="<?php echo base_url();?>index.php?admin/diagnostic_service/edit/<?php echo $row['diagnosticservice_id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/diagnostic_service/delete/<?php echo $row['diagnosticservice_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/diagnostic_service/create' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                         <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('title');?></label>
                                <div class="controls">

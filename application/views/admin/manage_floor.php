		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo get_phrase('edit_floor');?>
                    	</a></li>
            <?php endif;?>
			<li class="<?php if(!isset($edit_profile))echo 'active';?>">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo get_phrase('floor_list');?>
                    	</a></li>
			<li>
          ...
          <?php	if(isset($edit_profile)):?>
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_floor/edit/do_update/'.$row['floor_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('floor name');?></label>
                                <div class="controls">
                                <input type="text" class="validate[required]" name="floor_name" id="floor_name" value="<?php echo $row['floor_name'];?>"/>
                                </div>
                            </div>
                           </div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('edit_floor');?></button>
                        </div>
                    <?php echo form_close();?>
                    <?php endforeach;?>
                </div>
            ...
            <!----TABLE LISTING STARTS--->
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                    	<?php  $count = 1;foreach($floors as $rows):
                 	$rep_html .='   <tr>
                    <td style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;">'.($count++).'</td>
					<td style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;">'. $rows['floor_name'].'</td>
                        </tr>';
						        endforeach;
                        ?>
                     ...
                     <?php  $count = 1;foreach($floors as $rows):?>
                        <tr>
							...
							<td align="center">
                            <a href="<?php echo base_url();?>index.php?admin/manage_floor/edit/<?php echo $rows['floor_id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/manage_floor/delete/<?php echo $rows['floor_id'];?>" onclick="return confirm('delete?')"
            ...
            <?php 
						...
						file_put_contents("reports/floor.pdf", $pdf);
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/manage_floor/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
							<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('floor name');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="floor_name" id="floor_name"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('add_floor');?></button>
                        </div>
                    <?php echo form_close();?>                
                </div>                
			</div>
...
<!-- JavaScript Patient Validation Code Start -->
	...
	$(document).ready(function () {
		$("#floor_name").bind("keypress", function (event) {
		if (event.charCode!=0) {

...
<!--                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text"  class="validate[required]" name="phone" id="phone" value="<?php echo $row['phone'];?>"/>
                                </div>
                            </div>
							<div class="control-group">
...
<!--                            <div class="control-group">
							...
							<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('joining date');?></label>
                                <div class="controls">
                                    <input type="text" class="datepicker fill-up" name="doj" id="doj"/>
                                </div>
                            </div>
                             <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('ratio (%)');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="ratio" id="ratio" max="6"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('department');?></label>
                                <div class="controls">
                                    <select name="department_id" class="chzn-select">
							 ...
							 <div class="control-group">
                                ...
                                <div class="controls">
                                    <select name="speciality_id" class="chzn-select" >
								    <option value="null">None</option>
                                    	<?php 
							...
							<div class="control-group">
							 ...
							 <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('create by');?></label>
                                <div class="controls">
                        <input type="text" readonly="readonly" class="validate[required]"  name="created_by" id="created_by" placeholder="Enter Name" value="<?php echo $this->crud_model->get_type_name_by_id($account_type , $this->session->userdata($account_id) , 'name'); ?>"/>
                                </div>
                            </div>
                            <!--<div class="control-group">

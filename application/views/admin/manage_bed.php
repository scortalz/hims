		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_bed/edit/do_update/'.$row['bed_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
              ...
              <option value="Private Rooms" <?php if($row['type']=='Private Rooms')echo 'selected';?>><?php echo get_phrase('Private Rooms');?></option>
			  <option value="Semi Private Rooms" <?php if($row['type']=='Semi Private Rooms')echo 'selected';?>><?php echo get_phrase('Semi Private Rooms');?></option>
             <option value="female general ward" <?php if($row['type']=='female general ward')echo 'selected';?>><?php echo get_phrase('female general ward');?></option>
            <option value="male general ward" <?php if($row['type']=='male general ward')echo 'selected';?>><?php echo get_phrase('male general ward');?></option>
           <option value="icu" <?php if($row['type']=='icu')echo 'selected';?>><?php echo get_phrase('icu');?></option>
		   <option value="Nicu" <?php if($row['type']=='Nicu')echo 'selected';?>><?php echo get_phrase('Nicu');?></option>
										<option value="Emergency (ER)" <?php if($row['type']=='Emergency (ER)')echo 'selected';?>><?php echo get_phrase('Emergency (ER)');?></option>
          <option value="supplementary beds" <?php if($row['type']=='supplementary beds')echo 'selected';?>><?php echo get_phrase('supplementary beds');?></option>
                                    </select>
                                </div>
                            </div>
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="" name="charges" value="<?php echo $row['charges'];?>"/>
                                </div>
                            </div>
                            <div class="control-group">
         ...
         <?php	$rep_html =' <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive" style="width:100%;">
                    ...
                    $rep_html .=' <tr>
						...
						<td style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;">'.$row['charges'].'</td>
                        </tr>';
                              endforeach;
                        ?>
                        ...
                        <tr>
							...
							<td align="center">
                            <a href="<?php echo base_url();?>index.php?admin/manage_bed/edit/<?php echo $row['bed_id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/manage_bed/delete/<?php echo $row['bed_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/manage_bed/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('bed_number');?></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('type');?></label>
                                <div class="controls">
							   <select name="type" id="type" class="uniform" style="width:100%;">
                              <option value="Private Rooms"><?php echo get_phrase('Private Rooms');?></option>
							  <option value="Semi Private Rooms"><?php echo get_phrase('Semi Private Rooms');?></option>
                          <option value="female general ward"><?php echo get_phrase('female general ward');?></option>
                             <option value="male general ward"><?php echo get_phrase('male general ward');?></option>
                              <option value="icu"><?php echo get_phrase('icu');?></option>
							  <option value="Nicu"><?php echo get_phrase('nicu');?></option>
										<option value="Emergency (ER)"><?php echo get_phrase('Emergency (ER)');?></option>
      				<option value="supplementary beds"><?php echo get_phrase('supplementary beds');?></option>
                                    </select>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('description');?></label>
                             ...
                             <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('charges');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="charges" id="charges"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">

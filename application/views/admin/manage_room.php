          ...
          <?php	if(isset($edit_profile)):?>
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_room/edit/do_update/'.$row['room_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                     ...
                     <?php  $count = 1;foreach($rooms as $rows):?>
                        <tr>
                           ...
                           <td><?php echo $rows['room_name'];?></td>
							...
							<td align="center">
                            <a href="<?php echo base_url();?>index.php?admin/manage_room/edit/<?php echo $rows['room_id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/manage_room/delete/<?php echo $rows['room_id'];?>" onclick="return confirm('delete?')"

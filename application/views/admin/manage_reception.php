		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo get_phrase('edit_reception');?>
                    	</a></li>
            <?php endif;?>
			<li class="<?php if(!isset($edit_profile))echo 'active';?>">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo get_phrase('reception_list');?>
                    	</a></li>
			<li>
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_reception/edit/do_update/'.$row['reception_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('edit_reception');?></button>
                        </div>
                    <?php echo form_close();?>
                    <?php endforeach;?>
                </div>
            ...
            <!----TABLE LISTING STARTS--->
                  ...
                  <div class="tab-pane box <?php if(!isset($edit_profile))echo 'active';?>" id="list">
                	...
                	<thead>
                      ...
                      <h1>Manage Reception</h1></td>
                    	...
                    	<th style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;"><div>Reception Name</div></th>
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                      ...
                      <tr>
                       ...
                       <input type="button" name="btnReport" id="btnReport" value="Print Report" class="btn btn-green" title="Click here to print" /></td>
                		...
                		<tr>
							...
							<th><div><?php echo get_phrase('reception name');?></div></th>
                    ...
                    <tbody>
                    	<?php $count = 1;foreach($receptions as $row):
                     ...
                     <?php $count = 1;foreach($receptions as $row):?>
                        <tr>
							...
							<td align="center">
                            <a href="<?php echo base_url();?>index.php?admin/manage_reception/edit/<?php echo $row['reception_id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/manage_reception/delete/<?php echo $row['reception_id'];?>" onclick="return confirm('delete?')"
            ...
            <?php 
						...
						file_put_contents("reports/receptionregistration.pdf", $pdf);
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/manage_reception/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('name');?></label>
                                <div class="controls">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('add_reception');?></button>
                        </div>
                    <?php echo form_close();?>                
                </div>                
			</div>
...
<script type="text/javascript">
	$("#email").blur(function(){
			...
			$.post("<?php echo base_url();?>/application/helpers/checkduplicateemail.php", { post_email_id3 : value }, 
			function (data){
					if( data == 1)
					{
						if (value.length != 0 )
...
<!-- JavaScript Patient Validation Code Start -->
	...
	$(document).ready(function(e) {
        $('#btnReport').click(function () {
		  ...
		  var v = "reports/receptionregistration.pdf";
		  window.location = v;
 });
    });

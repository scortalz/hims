		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/Manage_Shift_Closed/edit/do_update/'.$row['Sh_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
    ...
    border-spacing:  5px;" cellspacing="0" border="2px solid black; width :100%;" class="dTable responsive">
                    ...
                    <tbody>
                        ...
                        <tr>
							...
							<td align = "center"><?php echo $row['Available_Cash'];?></td>
                            <td align = "center"><?php echo $row['reason'];?></td>
                            <td align = "center"><?php echo $row['Closing_Date'] ?></td>
							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?admin/Manage_Shift_Closed/edit/<?php echo $row['Sh_id'];?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                                		<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/Manage_Shift_Closed/delete/<?php echo $row['Sh_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/Manage_Shift_Closed/Create_Shift_Closed/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">

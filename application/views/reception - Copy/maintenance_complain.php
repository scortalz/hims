          ...
          <?php	if(isset($edit_profile)):?>
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('reception/maintenance_complain/edit/do_update/'.$row['comp_type_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
			...
			<div class="tab-pane box" id="add" style="padding: 5px;">
                <div class="box-content">
                    <?php echo form_open('reception/maintenance_complain/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
							<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('complain_title');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="complain_title" id="complain_title"/>
                                </div>
                            </div>
							<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('description');?></label>

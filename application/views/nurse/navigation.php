...
<div class="primary-sidebar">
	...
	<ul class="nav nav-collapse collapse nav-collapse-primary">
        ...
        <!------blood bank------>
		<?php /*?><li class="dark-nav <?php if($page_name == 'manage_blood_bank' || $page_name == 'manage_blood_donor')echo 'active';?>">
			<span class="glow"></span>
  ...
  <li class="<?php if($page_name == 'bed_schedule')echo 'dark-nav active';?>">
   <span class="glow"></span>
    <a href="<?php echo base_url();?>index.php?nurse/bed_schedule" >
   ...
   <!-------manage ot-------->
        ...
        <span class="glow"></span>
                  <a href="<?php echo base_url();?>index.php?nurse/manage_ot">
                      <i class="icon-hospital icon-2x"></i> <?php echo get_phrase('manage_oT');?>
                  </a>
                </li>
  
  <!-------OT Schedule-------->
		 <li class="<?php if($page_name == 'ot_schedules')echo 'active';?>">
         <span class="glow"></span>
                  <a href="<?php echo base_url();?>index.php?nurse/ot_schedules">
                      <i class="icon-hospital icon-2x"></i> <?php echo get_phrase('schedules');?>
                  </a>
                </li>

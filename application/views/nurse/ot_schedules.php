             ...
             <div class="span6" style='width:100%!important;'>
                ...
                <div class="box-content">
                   <!--<div id="schedule_calendar">-->
					...
					$current_time =	$arrRegNo1[0]['book_time']; //gmdate("h:i");// + '5.00.00';
				         ...
				         for ($i = 0; $i < 48; $i++) 
    				       {
						        ...
						        if (count($arrRegNo) > 0 )
								   {
									for ($m=0; $m< count($arrRegNo); $m++)
									{
									 ...
									 $display_range = strtotime($start_hour . '30 mins'); 
									 $db_time = $arrRegNo[$m]['book_time'];
									 $id = $arrRegNo[$m]['id'];
							// echo "<div class='fc-widget-content' style='height:30px;font-size:18px;color:#fff'><p align='center' style='background-color:red'>". $start_hour. " - ".$display_range . " (Doctor Name: $doctor_name), (Anesthetics Name: $anesthesia_name) </p>\n</div>";  
							  ...
							  echo "<div class='fc-widget-content' style='height:30px;font-size:18px;color:#fff'><p align='center' style='background-color:red'>". $db_time ." (Doctor Name: $doctor_name), (Anesthetics Name: $anesthesia_name) </p>\n</div>";  

                ...
                <table class="table" style="background-color:#FBFCFC;" >
                	<tbody>
                		<tr>
                			...
                			<td><label>Name :</label><label style = "margin-left:2%;">Waqar Ali</label></td>
                			<td><label>Age :</label><label style = "margin-left:2%;">21</label></td>
                			<td><label>Sex :</label><label style = "margin-left:2%;">male</label></td>
                		    </tr>
                		    <tr>
                			<td><label>Department No  :</label><label style = "margin-left:2%;">1012</label></td>
                			<td><label>Phone # :</label><label style = "margin-left:2%;">+923 43 2618641</label></td>
                			<td><label>Mobile # :</label><label style = "margin-left:2%;">+923 43 2618641</label></td>
                		    </tr>
                		    <tr>
                			<td><label>Cons. phy / Clinic :</label><label style = "margin-left:20px;">Doc Tabish Javed Vayani</label></td>
                			<td colspan="2"><label>Specimen Collection Date :</label><label style = "margin-left:20px;">9-nov-2016</label></td>
			...
			<div class="contain">
				...
				<table class="table">
						...
						<tr>
                            ...
                            <td colspan=""><label></label><label >81 ml</label></td>
                            <td><label>0.5-1.5 L/ Day</label></td>
						</tr>
						
						<tr>
							<td><label>Color</label></td>
                            <td colspan=""><label></label><label >Yellow</label></td>
                            <td><label>Straw - Yellow</label></td>
						</tr>
						<tr>
							<td><label>Appearance</label></td>
                            <td colspan=""><label></label><label >1.015</label></td>
                            <td><label></label></td>
						</tr>
						<tr>
						...
						<tr>
                            ...
                            <td colspan=""><label></label><label >60</label></td>
						...
						<tr>
                            ...
                            <td colspan=""><label></label><label >Negitive</label></td>
						...
						<tr>
							<td><label>Bite</label></td>
                            <td colspan=""><label></label><label >Negitive</label></td>
                            <td><label>Negitive</label></td>
						</tr>
						<tr>
							<td><label>Urobilinogen</label></td>
                            <td colspan=""><label></label><label >Normal</label></td>
                            <td><label>0.3 mmol / 1</label></td>
						</tr>
						<tr>
							<td><label>Kctone</label></td>
                            <td colspan=""><label></label><label >Negitive</label></td>
                            <td><label>Negitive</label></td>
						</tr>
						<tr>
						...
						<tr>
                            ...
                            <td colspan=""><label></label><label >04-06</label></td>
                            <td><label> < 10 / H . P . F </label></td>
						</tr>
						<tr>
							<td><label>Red Cells</label></td>
                            <td colspan=""><label></label><label >11.0</label></td>
						...
						<tr>
                            ...
                            <td colspan=""><label></label><label >Not Screen</label></td>
                            <td><label>  Nill </label></td>
						</tr>
						<tr>

          ...
          <?php	if(isset($edit_profile)):?>
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('reception/assigned_room/edit/do_update/'.$row['assignedroom_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
            ...
            <!----SEARCH FORM STARTS--->
                ...
                <div class="box-content">
            <?php echo form_open('reception/assigned_room/search/' , array('class' => 'form-horizontal validatable'));?>
                    Advanced Search

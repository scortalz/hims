		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('reception/manage_department/edit/do_update/'.$row['department_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="description" id="description" value="<?php echo $row['description'];?>"/>
                                </div>
                            </div>
                            </div>
				...
				<?php $rep_html =' <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive" style="width:100%;">
                	<thead>
                      ...
                      <h1>Manage Departmnet</h1></td>
                    	...
                    	<th style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;"><div>Department Name</div></th>
                    ...
                    <tbody>
                     ...
                     $rep_html .='  <tr>
					  ...
					  endforeach;
						...
						<td align="center">
                           	<a href="<?php echo base_url();?>index.php?reception/manage_department/edit/<?php echo $row['department_id'];?>"
            ...
            <?php 
					/*
						...
						file_put_contents("reports/department.pdf", $pdf);
						*/
				   ?>
             </div>   
            <!----TABLE LISTING ENDS--->
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('reception/manage_department/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('name');?></label>
                                <div class="controls">
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('description');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="description" id="description"/>     
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">

    ...
    <div class="tab-content">
      ...
      <div class="tab-pane box" id="add" style="padding: 5px">
                ...
                <p><span class="badge" id="error" style="margin-left: 7px; display:none;"></span></p>
                    <?php echo form_open('reception/manage_invoice/create' , array('class' => 'form-horizontal novalidate','id' => 'createform'));?>
                ...
                success: function(response) {
                    ...
                    if ($.isNumeric(response.doctor_id) == true) {
                        ...
                        jQuery.ajax({
                            ...
                            data: ({
                                post_doctor_id: response.doctor_id
                            }),
...
// $('#cbox').click(function(e) {
  ...
  $('#con').click (function () {
    if ($('#con').is(':checked') && $('#con').val() == 'C') 
    {
      $("#tblservice_catalog_detail td").remove();
  ...
  if ($('#cbox').is(':checked')) {
   ...
   patient = $('#patient_reg_no').val();

  } else {

   patient = $('#patient_id :selected').attr('mrnum');
   var patientid = $('#patient_id :selected').val();
  }

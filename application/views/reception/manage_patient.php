                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
						...
						?>
							...
							<td align="center">
<?php/* SELECT p.name AS patname, p.phone, d.name AS doctorname, i.invoice_number,i.totalamount, i.creation_timestamp,i.invoice_id
FROM invoice i JOIN patient p ON p.patient_id = i.patient_id JOIN doctor d ON i.doctor_id = d.doctor_id
ORDER BY i.invoice_id DESC */?>
                            	<a href="<?php echo base_url();?>index.php?reception/manage_invoice/<?php echo $row['patname'];?>"
			...
			<div class="tab-pane box" id="add" style="padding: 5px" >
                <div class="box-content">
                    ...
                    <form method="post" action="<?php echo base_url();?>index.php?" class="form-horizontal validatable">
                        ...
                        <div class="form-actions">
                           <a href=""  target="_blank"> <button type="submit" class="btn btn-blue"><?php echo get_phrase('add_patient');?></button></a>

    ...
    <div class="box-content padded" >
        <div class="tab-content" >
            ...
            <!--TABLE LISTING STARTS-->
             ...
             <div class="container well" style="width: 74.5vw;">
                <p id="date_filter">
    ...
    <button class="btn btn-default" id="reset_btn">Reset</button>
              ...
              <input type="submit" name="submitit" id="submitit" class="btn btn-block btn-primary" value="View expense voucher" >
              <?php echo form_close(); ?>
             </div>   
            <!--TABLE LISTING ENDS-->
                    ...
                    <form method="post" action="<?php echo base_url();?>index.php?" class="form-horizontal validatable">
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="date" name="date" <!-- REMOVE FUTURE DATES max="<?php echo date("Y-m-d"); ?>" -->/>
                                </div>
                            </div>
                           <div class="control-group">

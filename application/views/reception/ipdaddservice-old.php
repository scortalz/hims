...
<!--<form method="post" id="frmmanual_invoice" name="frmmanual_invoice">-->
  ...
  <br>
  		<p><span class="badge" id="txtHintmain" style="margin-left: 7px;"></span></p>
		...
		data: ({post_reg_no: reg_no}),
			success: function(response)	
			{
				...
				for(i=0; i<as.length;i++){
					...
					+ "</td><td style='width: 8%;'  align='right' contenteditable='true' onfocusout='myEditFunc3(this)'class='received_amt' id='received_amt'>" 

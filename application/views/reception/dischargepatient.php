             ...
             <div class="tab-pane box <?php if(!isset($edit_profile))echo 'active';?>" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
					 ...
					 <td style="color:rgb(55,158,196);font-weight:bold;text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;">'.$row['name'].'</td>
					...
					<td style="color:rgb(55,158,196);font-weight:bold;text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;">
					...
					'.$row['discharge_type'].'</td>';
						 ...
						 if ($row['discharge_type']=='normal')
 					  {
                        ...
                        <tr>
							...
							<td>
                          		<a  target="_blank" href="application/helpers/admittedpatientpaymenthistory.php?r=<?php echo $row['patient_reg_no'];?>" 
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('detail');?>" class="btn btn-red icon-print">

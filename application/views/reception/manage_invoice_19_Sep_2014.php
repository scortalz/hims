			...
			<input type="checkbox" name="sameasabove" id="sameasabove" /><span style="vertical-align:middle">&nbsp;Same as above</span>
                         ...
                         <input type="text" name="recievedamount" id="recievedamount" value="<?php echo $row['recievedamount'];?>"/>
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input readonly="readonly" type="text" name="careof" id="careof" value="value="<?php echo $this->crud_model->get_type_name_by_id($account_type , $this->session->userdata($account_id) , 'name'); ?>""/>
                                </div>
                            </div>
							<!--<div class="control-group">
                      ...
                      <input type="text" name="invoice_no" id="invoice_no" readonly="readonly" value="<?php echo $gen_inv_no; ?>"/>
                          ...
                          <input type="radio" name="radio" id="con" value = "C" checked="checked" tabindex="2"/>&nbsp;Consultation
						   <input type="radio" name="radio" id="dia" value="D" tabindex="3" />&nbsp;Diagnostic
                            ...
                            <table  id="tblservice_catalog" name="tblservice_catalog" border="1" class="awTable" align="right">
                            <tr>
                               <td align="right" >
				<input type="button" id="addmore" name="addmore" value="Add Service"  class="btn btn-green"/> 
			</td></tr></table>
                            <br />
                            	<table id="tblservice_catalog_detail" width="50%" class="awTable" align="right">
                                <thead>
                                 <tr style="height:20px!important;">
                       <th align="center" style="border: 1px solid ##B7B7B7; background-color:#CDCDCD;width:12%;">Category Name</th>
                       <th align="center" style="border: 1px solid ##B7B7B7; background-color:#CDCDCD;width:20%;">Serivce Name</th>
                       <th align="center" style="border: 1px solid ##B7B7B7; background-color:#CDCDCD;width:12%;">Amount </th>
...
$(document).ready(function(e) {
   ...
   $('#dia').click (function () {
		if ($('#dia').is(':checked') && $('#dia').val() == 'D') 
		{
			...
			$('#services').show('slow');
			$('#doctors').hide('slow');
			$('#tblservice_catalog_detail').show('slow');
			$('#addmore').show('slow');
			$('#totalamount').val('');
			$('#discountamount').val('');
			$('#discount').val('');
	...
	$('#con').click (function () {
		if ($('#con').is(':checked') && $('#con').val() == 'C') 
		{
			...
			$('#services').hide('slow');
			$('#doctors').show('slow');
			$('#tblservice_catalog_detail').hide('slow');
			$('#addmore').hide('slow');
			$('#totalamount').val('');
			$('#discountamount').val('');
			$('#discount').val('');
...
function addTableRow() {
				...
				var s_service_price= $('#serviceprice').val();
				var appendTxt = "";
...
$("#tblservice_catalog_detail tr:last").hide().fadeIn('slow');
          	...
          	/*	var sum = 0;
				...
				var sum = 0;
				$('#s_service_price').each(function() 
				{
					 sum =sum + parseFloat($(this).text());
					 alert(sum);return sum;
				});
				$('#serviceprice').val(sum);

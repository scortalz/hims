...
<html>
	...
	<head>
	<title>Department of Imunology</title>
		...
		<div class="wrapper">
			<div class="header">
				...
				<div class="info_header">
					<?php if($immunology_report_data->num_rows()>0){?>
					<?php foreach($immunology_report_data->result() as $data): ?>
			...
			<div class="contain">
				<div class="heading" style="width:100%;font-size:20px;margin-top:0px;"><center>Department Of Immunology</center></div>
				<table class="table">
						...
						<tr style="height:400px !important;">
							<td><label>Blood HCG</label></td>
                            <td colspan=""><label></label><label ><?php echo $data->blood_hcg?></label></td>
                            <td><label></label></td>
						</tr>

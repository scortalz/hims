		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_bed_allotment/edit/do_update/'.$row['bed_allotment_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
         ...
         <option value="<?php echo $row2['bed_id'];?>" <?php if($row2['bed_id'] == $row['bed_id'])echo 'selected';?>>
                      ...
                      <?php  $count = 1;foreach($bed_allotment as $row): ?>
                        <tr>
                           ...
                           <!-- <td><?php echo date('d/m/Y', $row['discharge_timestamp']); ?></td>-->
							<td align="center">
                           <!-- <a href="<?php echo base_url();?>index.php?admin/manage_bed_allotment/edit/<?php echo $row['bed_allotment_id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>-->
                            	<a href="<?php echo base_url();?>index.php?admin/manage_bed_allotment/delete/<?php echo $row['bed_allotment_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/manage_bed_allotment/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('bed_number');?></label>
                                <div class="controls">
                      ...
                      <!--       <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('allotment_time');?></label>
                                <div class="controls">
                                    <input type="text" required="required" class="datepicker fill-up" name="allotment_timestamp"/>
                                </div>
                            </div>
                           <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('discharge_time');?></label>

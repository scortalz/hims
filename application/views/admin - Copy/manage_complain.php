...
<div class="box">
          ...
          <?php	if(isset($edit_profile)):?>
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_complain/edit/do_update/'.$row['id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
            ...
            <!----EDITING FORM ENDS--->
             ...
             <!----SEARCH FORM STARTS--->
                ...
                <div class="box-content">
            <?php echo form_open('admin/manage_complain/search/' , array('class' => 'form-horizontal validatable'));?>
                    Advanced Search
   ...
   <!----SEARCH FORM ENDS--->
                     ...
                     <?php  $count = 1;foreach($complains as $rows):?>
                        ...
                        <td><?php echo $this->crud_model->get_type_name_by_id_custom('complain_type',$rows['comp_type_id'],'complain_title');?></td>
                           ...
                           <td><?php echo $rows['status'];?></td>
							<td align="center">
                            <a href="<?php echo base_url();?>index.php?admin/manage_complain/edit/<?php echo $rows['id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/manage_complain/delete/<?php echo $rows['id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/manage_complain/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('floor name');?></label>
                                <div class="controls">

                ...
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_patient/edit/do_update/'.$row['patient_id'] , array('class' => 'form-horizontal validatable'));?>
						...
						<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="refferedby" value="<?php echo $row['refferedby'];?>"/>
                                </div>
                            </div>
							<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('salutation');?></label>
                                <div class="controls">
                                       <select name="salutation" class="uniform">
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="father/husbandname" value="<?php echo $row['father/husbandname'];?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                    ...
                    <form method="post" action="<?php echo base_url();?>index.php?" class="form-horizontal validatable">
						...
						<div class="control-group">
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                   <select name="patient_type" class="uniform" style="width:100%;">
						...
						<div class="control-group">
							...
							<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('salutation');?></label>
                                <div class="controls">
                                    <select name="salutation" class="uniform" style="width:100%;">
							...
							<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('F / H. Name');?></label>
                                <div class="controls">
                                    <input type="text" class="validate[required]" name="father/husbandname" />
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('email');?></label>
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('birth_date');?></label>
                                <div class="controls">
                                    <input type="text"  class="datepicker fill-up"  name="birth_date" id="birth_date" value="<?php echo $current_date; ?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('age');?></label>

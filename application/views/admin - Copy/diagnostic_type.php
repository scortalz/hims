		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/diagnostic_type/edit/do_update/'.$row['diagnosticservice_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
				  ...
				  <td style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;">'.$row['name'].'</td>
                     ...
                     <?php $count = 1;foreach($diagnostictypes as $row):?>
                        <tr>
							...
							<td align="center">
                            <a href="<?php echo base_url();?>index.php?admin/diagnostic_type/edit/<?php echo $row['diagnostictype_id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/diagnostic_type/delete/<?php echo $row['diagnostictype_id'];?>" onclick="return confirm('delete?')"
            ...
            <?php 
						...
						file_put_contents("reports/diagnostictype.pdf", $pdf);
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/diagnostic_type/create' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                         <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('name');?></label>
                                <div class="controls">
 ...
 <script>
	...
	$(document).ready(function(e) {
        $('#btnReport').click(function () {
		  ...
		  var v = "reports/diagnostictype.pdf";
		  window.location = v;
 });
    });

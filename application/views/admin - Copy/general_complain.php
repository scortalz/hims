		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/general_complain/edit/do_update/'.$row['general_comp_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                    ...
                    <tbody>
                     ...
                     <?php $count = 1;foreach($general_complains as $row):?>
                        <tr>
							...
							<td align="center">
                            <a href="<?php echo base_url();?>index.php?admin/general_complain/edit/<?php echo $row['general_comp_id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/general_complain/delete/<?php echo $row['general_comp_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/general_complain/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                          <?php /*?>  <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('incident date');?></label>
                                <div class="controls">

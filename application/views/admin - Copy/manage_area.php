          ...
          <?php	if(isset($edit_profile)):?>
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/manage_area/edit/do_update/'.$row['area_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                     ...
                     <?php  $count = 1;foreach($areas as $rows):?>
                        <tr>
                           ...
                           <td><?php echo $rows['area'];?></td>
							<td align="center">
                            <a href="<?php echo base_url();?>index.php?admin/manage_area/edit/<?php echo $rows['area_id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/manage_area/delete/<?php echo $rows['area_id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/manage_area/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
						<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('floor');?></label>
                                <div class="controls">
							...
							<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('area name');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="area" id="area"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">

		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo get_phrase('edit_complain_management');?>
                    	</a></li>
            <?php endif;?>
			<li class="<?php if(!isset($edit_profile))echo 'active';?>">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo get_phrase('complain_management_list');?>
                    	</a></li>
			<li>
            	<a href="#add" data-toggle="tab"><i class="icon-plus"></i>
					<?php echo get_phrase('add_complain_management');?>
                    	</a></li>
		</ul>
    	<!------CONTROL TABS END------->
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('admin/complain_management/edit/do_update/'.$row['comp_manag_id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
						 <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('department');?></label>
                                <div class="controls">
                                    <select name="employee_id" class="uniform" style="width:100%;">
                                    	<?php 
										$employees = $this->db->get('employee')->result_array();
										foreach($employees as $row2):
										?>
                                    		<option value="<?php echo $row2['employee_id'];?>"
                                            	<?php if($row['employee_id'] == $row2['employee_id'])echo 'selected';?>>
													<?php echo $row2['dept'];?>
                                                    	</option>
                                        <?php
										endforeach;
								 ...
								 <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('employees');?></label>
                                <div class="controls">
                                    <select name="employee_id" class="uniform" style="width:100%;">
                                    	<?php 
										$employees = $this->db->get('employee')->result_array();
							...
							<div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" name="complainby" id="complainby" value="<?php echo $row['complainby'] ?>"/>
                                </div>
                            </div>
                  ...
                  <option value="non guilty" <?php if($row['option']=='non guilty')echo 'selected';?> > <?php echo get_phrase('non guilty');?></option>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('edit_complain_management');?></button>
                        </div>
                    <?php echo form_close();?>
                    <?php endforeach;?>
                </div>
            ...
            <!----TABLE LISTING STARTS--->
               ...
               <div class="tab-pane box <?php if(!isset($edit_profile))echo 'active';?>" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                    	<?php $count = 1;foreach($complain_managements as $row):
                 		  $rep_html .='  <tr>
                    <td style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;">'.($count++).'</td>
					<td style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;">'.$this->crud_model->get_type_name_by_id('employee',$row['employee_id'],'emp_name').'</td>
					<td style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;">'.$this->crud_model->get_type_name_by_id('employee',$row['employee_id'],'dept').'</td>
					...
					<td style="text-align:center;padding: 4px 2px 1px 4px; border: 1px solid; border-color: #0000;">'.$row['status'].'</td>
                     ...
                     <?php $count = 1;foreach($complain_managements as $row):?>
                        <tr>
                            ...
                            <td><?php echo $this->crud_model->get_type_name_by_id('employee',$row['employee_id'],'emp_name');?></td>
                            <td><?php echo $this->crud_model->get_type_name_by_id('employee',$row['employee_id'],'dept');?></td>
							<td><?php echo date('m/d/Y ', strtotime($row['incident_date']));?></td>
                            <td><?php echo $row['status'];?></td>
							<td align="center">
                            <a href="<?php echo base_url();?>index.php?admin/complain_management/edit/<?php echo $row['comp_manag_id'];?>"
                               rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                               	<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?admin/complain_management/delete/<?php echo $row['comp_manag_id'];?>" onclick="return confirm('delete?')"
            ...
            <?php 
						...
						file_put_contents("reports/complainmanagement.pdf", $pdf);
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('admin/complain_management/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
						<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('department');?></label>
                                <div class="controls">
                                    <select name="employee_id" class="uniform" style="width:100%;">
										...
										?>
                                    		<option value="<?php echo $row['employee_id'];?>"><?php echo $row['dept'];?></option>
                                        <?php
										endforeach;
										?>
                                    </select>
							...
							<div class="control-group">
                                <label class="control-label"><?php echo get_phrase('complain by');?></label>
                                <div class="controls">
                                  <input type="text"  name="complainby" id="complainby" class="validate[required]"/>
                                </div>
                            </div>
                            <?php /*?><div class="control-group">
                                <label class="control-label"><?php echo get_phrase('incident date');?></label>
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('add_complain_management');?></button>
                        </div>
                    <?php echo form_close();?>                
                </div>                
			</div>
...
<!-- JavaScript Patient Validation Code Start -->
	...
	$(document).ready(function () {
		$("#complainby").bind("keypress", function (event) {
		if (event.charCode!=0) {
	...
	$(document).ready(function(e) {
        $('#btnReport').click(function () {
		  ...
		  var v = "reports/complainmanagement.pdf";
		  window.location = v;
 });
    });

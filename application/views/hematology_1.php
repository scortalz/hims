		...
		<div class="wrapper">
			<div class="header">
				...
				<div class="info_header">
					...
					<?php foreach($hematology_data->result() as $data):?>
                <table class="table" style="background-color:#FBFCFC;" >
                	<tbody>
                		<tr>
                			
                			<td><label>Name :</label><label style = "margin-left:2%;"><?php echo $data->patient_name ;?></label></td>
                			<td><label>Age :</label><label style = "margin-left:2%;"><?php echo $data->age ;?></label></td>
                			<td><label>Sex :</label><label style = "margin-left:2%;"><?php echo $data->sex ;?></label></td>
                		    </tr>
                		    <tr>
                			<td><label>Invoice No  :</label><label style = "margin-left:2%;"><?php echo $data->invoice_no ;?></label></td>
                			<td><label>Phone # :</label><label style = "margin-left:2%;"><?php echo $data->phone ;?></label></td>
                			<td><label>Mobile # :</label><label style = "margin-left:2%;"><?php echo $data->mobile_no ;?></label></td>
                		    </tr>
                		    <tr>
                			<td><label>Cons. phy / Clinic :</label><label style = "margin-left:20px;"><?php echo $data->doc_name ;?></label></td>
                			<td colspan="2"><label>Specimen Collection Date :</label><label style = "margin-left:20px;"><?php echo $data->report_date ;?></label></td>
			...
			<div class="contain">
				<div class="heading" style="width:100%;font-size:20px;margin-top:0px;"><center>Department Of Hematology</center></div>
				<table class="table">
						...
						<tr>
                            ...
                            <td colspan=""><label></label><label ><?php echo $data->haemaglobin ;?></label></td>
                            <td><label>11.5-15.5 g/dl</label></td>
						</tr>
						<tr>
							<td><label>Red Cells</label></td>
                            <td colspan=""><label></label><label ><?php echo $data->red_cells ;?></label></td>
                            <td><label>3.8-5.2 10^12/1</label></td>
						</tr>
						<tr>
							<td><label>P.C.V</label></td>
                            <td colspan=""><label></label><label ><?php echo $data->pcv ;?></label></td>
                            <td><label>35-47 %</label></td>
						</tr>
						<tr>
							<td><label>M.C.V</label></td>
                            <td colspan=""><label></label><label ><?php echo $data->mcv ;?></label></td>
                            <td><label>80-100 ml</label></td>
						</tr>
						<tr>
							<td><label>M.C.H</label></td>
                            <td colspan=""><label></label><label ><?php echo $data->mch ;?></label></td>
                            <td><label>27-34 pg</label></td>
						</tr>
						<tr>
							<td><label>M.C.H.C</label></td>
                            <td colspan=""><label></label><label ><?php echo $data->mchc ;?></label></td>
                            <td><label>30-35 g/dl</label></td>
						</tr>
						<tr>
							<td><label>Morphology of R.B.C</label></td>
                            <td colspan=""><label></label><label ><?php echo $data->morphology ;?></label></td>
                            <td><label>30-35 g/dl</label></td>
						</tr>

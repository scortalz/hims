<div class="box">
			...
			<li>
            	<a href="#add" data-toggle="tab"><i class="icon-plus"></i>
					<?php echo get_phrase('add_report');?>
                        ...
                        <li>
               <?php $image="uploads/tick.png"?>
                <a href="#processed_report" data-toggle="tab"><i ><img src="<?php echo base_url($image)?>"/></i>
                    <?php echo get_phrase('processed_reports');?>
                        </a></li>
	...
	<div class="box-content padded">
		<div class="tab-content">            
            ...
            <!--strat processed report work-->
            <div class="tab-pane box" id="processed_report">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                        <?php 
                        $count = 1;
                       if($hematology_work->num_rows()>0) {
                        foreach($hematology_work->result() as $data):?>
                        <tr>
                            <td><?php echo $count++;?></td>
                           ...
                           <td align="center">
                                ...
                                <a href="<?php echo base_url();?>index.php?laboratorist/mannage_Heamatology/<?php echo $data->id?>" target="blank"
                        ...
                        <?php endforeach; }?>
                        <?php 
                        if($hematology_1_work->num_rows()>0) {
                        foreach($hematology_1_work->result() as $data):?>
                        <tr>
                            <td><?php echo $count++;?></td>
                            <td><?php echo $data->patient_name;?></td>
                            <td><?php echo $data->doc_name;?></td>
                            ...
                            <td><?php echo $data->report_date;?></td>
                             <td align="center">
                                <?php $image="uploads/report_logo.png"?>
                                <a href="<?php echo base_url();?>index.php?laboratorist/manage_Heamatology_1/<?php echo $data->id?>" target="blank"
                                    rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('print');?>" class="btn btn-blue">
                                        <i ><img src="<?php echo base_url($image)?>"/></i>
                                </a>
                            </td>
                        ...
                        <?php endforeach; }?>
                        <?php 
                        if($parcytology_work->num_rows()>0) {
                        foreach($parcytology_work->result() as $data):?>
                        <tr>
                            <td><?php echo $count++;?></td>
                            <td><?php echo $data->patient_name;?></td>
                            <td><?php echo $data->doc_name;?></td>
                            ...
                            <td align="center">
                                <?php $image="uploads/report_logo.png"?>
                                <a href="<?php echo base_url();?>index.php?laboratorist/manage_paracytology/<?php echo $data->id?>" target="blank"
                                    rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('print');?>" class="btn btn-blue">
                                        <i ><img src="<?php echo base_url($image)?>"/></i>
                                </a>
                            </td> 
                        ...
                        <?php endforeach; }?>
                        <?php 
                        if($immunology_work->num_rows()>0) {
                        foreach($immunology_work->result() as $data):?>
                        <tr>
                            <td><?php echo $count++;?></td>
                            <td><?php echo $data->patient_name;?></td>
                            <td><?php echo $data->doc_name;?></td>
                            ...
                            <td align="center">
                                 <?php $image="uploads/report_logo.png"?>
                                <a href="<?php echo base_url();?>index.php?laboratorist/manage_Immunology/<?php echo $data->id?>" target="blank"
                                    rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('print');?>" class="btn btn-blue">
                                        <i ><img src="<?php echo base_url($image)?>"/></i>
                                </a>
                            </td> 
                        ...
                        <?php endforeach; }?>
                        <?php 
                        if($biochemistry_work->num_rows()>0) {
                        foreach($biochemistry_work->result() as $data):?>
                        <tr>
                            <td><?php echo $count++;?></td>
                            <td><?php echo $data->patient_name;?></td>
                            <td><?php echo $data->doc_name;?></td>
                            ...
                            <td align="center">
                                <?php $image="uploads/report_logo.png"?>
                                <a href="<?php echo base_url();?>index.php?laboratorist/manage_biochemistry/<?php echo $data->id?>" target="blank"
                                    rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('print');?>" class="btn btn-blue">
                                        <i ><img src="<?php echo base_url($image)?>"/></i>
                                </a> 
                            </td>

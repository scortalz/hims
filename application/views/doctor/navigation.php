...
<div class="primary-sidebar">
	...
	<ul class="nav nav-collapse collapse nav-collapse-primary">
        ...
        <!------bed allotment----->
		<?php /*?><li class="<?php if($page_name == 'manage_bed_allotment')echo 'dark-nav active';?>">
			<span class="glow"></span>
        ...
        <!------blood bank----->
		<?php /*?><li class="<?php if($page_name == 'view_blood_bank')echo 'dark-nav active';?>">
			<span class="glow"></span>
		...
		<!------manage report--->
		<?php /*?><li class="<?php if($page_name == 'manage_report')echo 'dark-nav active';?>">
			<span class="glow"></span>

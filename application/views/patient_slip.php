	...
	<body>
		...
		<div class="wrapper">
			...
			<div class="contain">
				...
				<table class="table">
                		...
                		<tr>
                			...
                			<td><label>Slip No :</label><label style = "margin-left:2%;"><?php echo $data->patient_reg_no;?></label></td>
                			<td><label>Date :</label><label style = "margin-left:2%;"><?php echo $data->admission_date;?></label></td>
                		</tr>
                		<tr>
                			<td><label>Patient Name :</label><label style = "margin-left:2%;"><?php echo $data->name;?></label></td>
			...
			<!-- <table class="table tab">
			 ...
			 -->
                       <table class="table tab" frame="hsides" style="margin-top:300px !important;margin-top:600px !important;">
                       <tbody>
                        <tr>

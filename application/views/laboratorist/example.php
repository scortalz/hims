<div class="box">
    <div class="box-header">
        ...
        <ul class="nav nav-tabs nav-tabs-left">
            <?php if(isset($edit_hematology)):?>
            <li class="active">
                <a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
                    <?php echo get_phrase('edit_immunology_report');?>
                        </a></li>
            <?php endif;?>
            <li class="<?php if(!isset($edit_hematology))echo 'active';?>">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    <?php foreach($edit_hematology as $row):?>
            ...
            <div class="tab-pane box <?php if(!isset($edit_hematology))echo 'active';?>" id="list">

		...
		<ul class="nav nav-tabs nav-tabs-left">
			...
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo get_phrase('edit_heamatology_report');?>
                    	</a></li>
            <?php endif;?>
			<li class="<?php if(!isset($edit_hematology))echo 'active';?>">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo get_phrase('Heamatology_Report_list');?>
                    	</a></li>
			<!-- <li>
                            <a href="#add" data-toggle="tab"><i class="icon-plus"></i>
                    <?php echo get_phrase('add_heamatology_report');?>
                                    </a></li> -->
		</ul>
    	<!--CONTROL TABS END-->
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    ...
                    <?php echo form_open('laboratorist/manage_hematology_work/edit/do_update/'.$row['id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="" name="leucocytes" value="<?php echo $row['leucocytes'];?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="" name="haemoglobin" value="<?php echo $row['haemoglobin'];?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('red cells');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="redcells" value="<?php echo $row['redcells'];?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                        ...
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('edit_heamatology_report');?></button>
                        </div>
                    <?php echo form_close();?>
                    <?php endforeach;?>
                </div>
            ...
            <div class="tab-pane box <?php if(!isset($edit_hematology))echo 'active';?>" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                    	<?php $count = 1;foreach($hematology_report_data as $row):?>
                        <tr>
							...
							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?laboratorist/manage_hematology_work/edit/<?php echo $row['id'];?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                                		<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?laboratorist/manage_hematology_work/delete/<?php echo $row['id'];?>" onclick="return confirm('delete?')"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('laboratorist/manage_hematology_work/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('patient name');?></label>
                                <div class="controls">
                           ...
                           <!--  <div class="control-group">
                               ...
                               <div class="controls">
                                   <input type="text" class="datepicker fill-up" name="last_donation_timestamp"/>
                                                    ...
                                                    --></div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('add_hematology_report');?></button>
                        </div>
                    <?php echo form_close();?>                
                </div>                
			</div>

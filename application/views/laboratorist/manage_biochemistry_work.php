<div class="box">
	<div class="box-header">
		...
		<ul class="nav nav-tabs nav-tabs-left">
        	<?php if(isset($edit_biochemistry_report_data)):?>
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo get_phrase('edit_biochemistry_report');?>
                    	</a></li>
            <?php endif;?>
			<li class="<?php if(!isset($edit_biochemistry_report_data))echo 'active';?>">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo get_phrase('biochemistry_Report_list');?>
                    	</a></li>
			<!-- <li>
                            <a href="#add" data-toggle="tab"><i class="icon-plus"></i>
                    <?php echo get_phrase('add_biochemistry_report');?>
                                    </a></li> -->
		</ul>
    	<!--CONTROL TABS END-->
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                	<?php foreach($edit_biochemistry_report_data as $row):?>
                    <?php echo form_open('laboratorist/manage_biochemistry_work/edit/do_update/'.$row['id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            ...
                            <div class="control-group">
                               ...
                               <div class="controls">
                                   <input type="hidden" class="" name="laboratorist_name" value="<?php echo $row['laboratrist_name'];?>"/>
                               </div>
                           </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="" name="blood_hcg" value="<?php echo $row['glucose']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('calcium');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="blood_hcg" value="<?php echo $row['calcium']?>"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('edit_biochemistry_report');?></button>
                        </div>
                    <?php echo form_close();?>
                    <?php endforeach;?>
                </div>
            ...
            <div class="tab-pane box <?php if(!isset($edit_biochemistry_report_data))echo 'active';?>" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                    	<?php $count = 1;foreach($biochemistry_report_data as $row):?>
                        <tr>
							...
							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?laboratorist/manage_biochemistry_work/edit/<?php echo $row['id'];?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                                		<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?laboratorist/manage_biochemistry_work/delete/<?php echo $row['id'];?>" onclick="return confirm('delete?')"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete');?>" class="btn btn-red">
                                		<i class="icon-trash"></i>
                                </a>
                                <?php $image="uploads/report_logo.png"?>
                                <a href="<?php echo base_url();?>index.php?laboratorist/manage_biochemistry/<?php echo $row['id']?>" target="blank"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('laboratorist/manage_biochemistry_work/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('glucose (random)');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="glucose"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('calcium');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="calcium"/>
                                </div>
                            </div>
                           <!--  <div class="control-group">

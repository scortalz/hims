<div class="box">
    <div class="box-header">
        ...
        <ul class="nav nav-tabs nav-tabs-left">
            <?php if(isset($edit_hematology_report_data)):?>
            <li class="active">
                <a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
                    <?php echo get_phrase('edit_heamatology_report');?>
                        </a></li>
            <?php endif;?>
            <li class="<?php if(!isset($edit_hematology_report_data))echo 'active';?>">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                    <?php foreach($edit_hematology_report_data as $row):?>
                        ...
                        <tr>
                            ...
                            <td align="center">
                                ...
                                <a href="<?php echo base_url();?>index.php?laboratorist/mannage_Heamatology/<?php echo $row['id']?>" target="blank"
                                    rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('print_me');?>" class="btn btn-blue">

<div class="box">
	<div class="box-header">
		...
		<ul class="nav nav-tabs nav-tabs-left">
        	<?php if(isset($edit_paracytology_report_data)):?>
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo get_phrase('edit_paracytology_report');?>
                    	</a></li>
            <?php endif;?>
			<li class="<?php if(!isset($edit_biochemistry_report_data))echo 'active';?>">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo get_phrase('paracytology_Report_list');?>
                    	</a></li>
			<!-- <li>
                            <a href="#add" data-toggle="tab"><i class="icon-plus"></i>
                    <?php echo get_phrase('add_paracytology_report');?>
                                    </a></li> -->
		</ul>
    	<!--CONTROL TABS END-->
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                	<?php foreach($edit_paracytology_report_data as $row):?>
                    <?php echo form_open('laboratorist/manage_paracytology_work/edit/do_update/'.$row['id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="hidden" class="" name="department_no" value="<?php echo $row['department_no'];?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('cons . phy / clinic');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="doc_name" value="<?php echo $row['doc_name'];?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                               ...
                               <div class="controls">
                                   <input type="hidden" class="" name="laboratorist_name" value="<?php echo $row['laboratorist_name'];?>"/>
                               </div>
                           </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('report_date');?></label>
                                <div class="controls">
                                    <input type="text" class="datepicker fill-up" name="report_date" value="<?php echo $row['report_date'];?>"/>
                                </div>
                            </div>
                             <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('volume');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="volume" value="<?php echo $row['volume']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('colour');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="color" value="<?php echo $row['color']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('appearance');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="appearance" value="<?php echo $row['appearance']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('specific_gravity');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="specific_gravity" value="<?php echo $row['specific_gravity']?>"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="" name="ph" value="<?php echo $row['ph']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('glucose');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="glucose" value="<?php echo $row['glucose']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('albumin');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="albumin" value="<?php echo $row['albumin']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('bile');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="bile" value="<?php echo $row['bile']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('urobilinogen');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="urobilinogen" value="<?php echo $row['urobilinogen']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('ketone');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="ketone" value="<?php echo $row['ketone']?>"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="" name="nitrite" value="<?php echo $row['nitrite']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('blood');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="blood" value="<?php echo $row['blood']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('pus_cell');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="pus_cell" value="<?php echo $row['pus_cell']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('red_cell');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="red_cell" value="<?php echo $row['red_cell']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('epithelial_cell');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="epithelial_cell" value="<?php echo $row['epithelial_cell']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('bacteria');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="bacteria" value="<?php echo $row['bacteria']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('yeast_cell');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="yeast_cell" value="<?php echo $row['yeast_cell']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('crystal');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="crystal" value="<?php echo $row['crystal']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('amorphose_urates');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="amorphose_urates" value="<?php echo $row['amorphose_urates']?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('granular_cast');?></label>
                                <div class="controls">
                                    <input type="text" class="" name="granular_cast" value="<?php echo $row['granular_cast']?>"/>
                                </div>
                            </div>
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="" name="calcium_oxalate" value="<?php echo $row['calcium_oxalate']?>"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('edit_paracytology_report');?></button>
                        </div>
                    <?php echo form_close();?>
                    <?php endforeach;?>
                </div>
            ...
            <div class="tab-pane box <?php if(!isset($edit_paracytology_report_data))echo 'active';?>" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                    	<?php $count = 1;foreach($paracytology_report_data as $row):?>
                        <tr>
							...
							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?laboratorist/manage_paracytology_work/edit/<?php echo $row['id'];?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                                		<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?laboratorist/manage_paracytology_work/delete/<?php echo $row['id'];?>" onclick="return confirm('delete?')"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete');?>" class="btn btn-red">
                                		<i class="icon-trash"></i>
                                </a>
                                <?php $image="uploads/report_logo.png"?>
                                <a href="<?php echo base_url();?>index.php?laboratorist/manage_paracytology/<?php echo $row['id']?>" target="blank"
			...
			<div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open('laboratorist/manage_paracytology_work/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="" name="department_no"/>
                                </div>
                            </div>
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('cons . phy / clinic');?></label>

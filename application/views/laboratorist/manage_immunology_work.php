<div class="box">
	<div class="box-header">
		...
		<ul class="nav nav-tabs nav-tabs-left">
        	<?php if(isset($edit_immunology_report_data)):?>
			<li class="active">
            	<a href="#edit" data-toggle="tab"><i class="icon-wrench"></i> 
					<?php echo get_phrase('edit_immunology_report');?>
                    	</a></li>
            <?php endif;?>
			<li class="<?php if(!isset($edit_immunology_report_data))echo 'active';?>">
            	<a href="#list" data-toggle="tab"><i class="icon-align-justify"></i> 
					<?php echo get_phrase('immunology_Report_list');?>
                    	</a></li>
			<!-- <li>
                            <a href="#add" data-toggle="tab"><i class="icon-plus"></i>
                    <?php echo get_phrase('add_immunology_report');?>
                                    </a></li> -->
		</ul>
    	<!--CONTROL TABS END-->
		...
		<div class="tab-content">
			...
			<div class="tab-pane box active" id="edit" style="padding: 5px">
                <div class="box-content">
                	<?php foreach($edit_immunology_report_data as $row):?>
                    <?php echo form_open('laboratorist/manage_immunology_work/edit/do_update/'.$row['id'] , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="hidden" class="" name="department_no" value="<?php echo $row['depart_no'];?>"/>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                             ...
                             <div class="control-group">
                                ...
                                <div class="controls">
                                    <input type="text" class="" name="blood_hcg" value="<?php echo $row['blood_hcg']?>"/>
                                </div>
                            </div>
                        </div>
                        <div class="form-actions">
                            <button type="submit" class="btn btn-blue"><?php echo get_phrase('edit_immunology_report');?></button>
                        </div>
                    <?php echo form_close();?>
                    <?php endforeach;?>
                </div>
            ...
            <div class="tab-pane box <?php if(!isset($edit_immunology_report_data))echo 'active';?>" id="list">
                ...
                <table cellpadding="0" cellspacing="0" border="0" class="dTable responsive">
                    ...
                    <tbody>
                    	<?php $count = 1;foreach($immunology_report_data as $row):?>
                        <tr>
							...
							<td align="center">
                            	<a href="<?php echo base_url();?>index.php?laboratorist/manage_immunology_work/edit/<?php echo $row['id'];?>"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('edit');?>" class="btn btn-blue">
                                		<i class="icon-wrench"></i>
                                </a>
                            	<a href="<?php echo base_url();?>index.php?laboratorist/manage_immunology_work/delete/<?php echo $row['id'];?>" onclick="return confirm('delete?')"
                                	rel="tooltip" data-placement="top" data-original-title="<?php echo get_phrase('delete');?>" class="btn btn-red">
                                		<i class="icon-trash"></i>
                                </a>
                                <?php $image="uploads/report_logo.png"?>
                                <a href="<?php echo base_url();?>index.php?laboratorist/manage_Immunology/<?php echo $row['id']?>" target="blank"
                ...
                <div class="box-content">
                    <?php echo form_open('laboratorist/manage_immunology_work/create/' , array('class' => 'form-horizontal validatable'));?>
                        <div class="padded">
                            ...
                            <div class="control-group">
                                <label class="control-label"><?php echo get_phrase('laboratorist_name');?></label>
                                <div class="controls">

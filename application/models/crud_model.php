...
class Crud_model extends CI_Model {
	...
	{
		$ans = $this->db->get_where($type,array($type.'_id'=>$type_id));
		if($ans->num_rows() > 0) {

		return $ans->row()->$field;	
	}
}
	
	// this is custom function querry for complain_type....
	...
	// this is custom function querry for surgery....

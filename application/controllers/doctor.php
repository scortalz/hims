...
class Doctor extends CI_Controller
{
	...
	function manage_report($param1 = '', $param2 = '', $param3 = '')
	{
		...
		$page_data['hematology_work']      = $this->db->get('hematology_work');
		$page_data['hematology_1_work']    = $this->db->get('hematology_1_work');
		$page_data['biochemistry_work']    = $this->db->get('biochemistry_work');
		$page_data['parcytology_work']    = $this->db->get('parcytology_work');
		$page_data['immunology_work']      = $this->db->get('immunology_work');
		$this->load->view('index', $page_data);
	}

   ...
   function bed_schedule($param1 = '', $param2 = '', $param3 = '')
    {
      ...
      //$page_data['ot_schedules'] = $this->db->get('ot_schedule')->result_array();
 	...
 	function manage_ot($param1 = '', $param2 = '', $param3 = '')
	{
	  ...
	  if ($param1 == 'create') {
	   ...
	   redirect(base_url() . 'index.php?nurse/manage_ot', 'refresh');
	  }
	 ...
	 /******MANAGE SCHEDULES*****/
	function ot_schedules($param1 = '', $param2 = '', $param3 = '')
	{
		if ($this->session->userdata('nurse_login') != 1)
			redirect(base_url() . 'index.php?login', 'refresh');
	
		$page_data['page_name']  = 'ot_schedules';
		$page_data['page_title'] = get_phrase('Schedules');
		//$page_data['ot_schedules'] = $this->db->get('ot_schedule')->result_array();

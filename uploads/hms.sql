...
(12, 'reception', 'reception', 'হিসাবরক্ষক', 'contador', 'محاسب,en', 'boekhouder', 'бухгалтер', '会计,en', 'muhasebeci', 'contador', 'könyvelő', 'comptable', 'λογιστής', 'Buchhalter', 'ragioniere', 'สมุห์บัญชี', 'اکاؤنٹنٹ', 'मुनीम', 'Ratiocinatore', 'akuntan', '会計士', '회계 원'),
